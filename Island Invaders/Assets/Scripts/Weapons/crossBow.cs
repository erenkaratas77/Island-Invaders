...
public class crossBow : MonoBehaviour
{
    ...
    IEnumerator shootEnemy(Transform target)
    {
        ...
        wM.transform.GetChild(wM.weoponCurrentLVL).GetComponentInChildren<Weapon>().transform.DOLocalMoveZ(-.6f, 0.2f).OnComplete(() =>
        ...
        wM.transform.GetChild(wM.weoponCurrentLVL).GetComponentInChildren<Weapon>().GetComponentInChildren<MeshRenderer>().enabled = false;
        wM.transform.GetChild(wM.weoponCurrentLVL).GetComponentInChildren<Weapon>().transform.localScale = Vector3.zero;
        wM.transform.GetChild(wM.weoponCurrentLVL).GetComponentInChildren<Weapon>().transform.localPosition = Vector3.zero;
        wM.transform.GetChild(wM.weoponCurrentLVL).GetComponentInChildren<Weapon>().GetComponentInChildren<MeshRenderer>().enabled = true;
        wM.transform.GetChild(wM.weoponCurrentLVL).GetComponentInChildren<Weapon>().transform.DOScale(1, .4f);
